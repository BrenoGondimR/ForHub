<template>
  <b-row class="main-flux">
    ...
    <b-row class="mt-2">
      <b-colxx class="mt-5" lg="3" v-for="(acomodacao, index) in acomodacoesPatrocinadas" :key="index" style="">
        <card-acomodacao
      ...
      <b-colxx class="mt-5" lg="4" v-for="(acomodacao, index) in detalhesForHub" :key="index" style="">
        <card-acomodacao
            :image="acomodacao.imagem"
            :title="acomodacao.title"
            :price="acomodacao.price"
...
export default {
  ...
  data() {
    return {
      ...
      detalhesForHub: [
        { imagem: escritorioMeirelesImg, title: 'Reserve Sob Demanda', price: 'Reserve espaços de trabalho e salas de reunião em todo o mundo'},
        { imagem: escritorio2Img, title: 'Estenda Sua Equipe', price: 'Economize tempo e dinheiro com um plano de membros que oferece acesso ilimitado a espaços de coworking ao redor do mundo'},
        { imagem: escritorio3Img, title: 'Planeje Eventos', price: 'Encontre o local perfeito para o seu próximo evento, seja uma reunião de diretoria, conferência ou lançamento de produto'},
      ],
