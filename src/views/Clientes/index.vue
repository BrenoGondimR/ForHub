    ...
    <b-colxx lg="12">
      <TabView>
        <TabPanel header="Ativos">
          <DataTable :value="activeCustomers" paginator :rows="5" tableStyle="min-width: 50rem">
        ...
        <TabPanel header="Inativos">
          <DataTable :value="inactiveCustomers" paginator :rows="5" tableStyle="min-width: 50rem">
            <Column field="name" header="Nome" style="width: 16%">
              <template #body="slotProps">
                <div class="customer-badge" :class="slotProps.data.badgeClass">
                  <span class="customer-initials">{{ getInitials(slotProps.data.name) }}</span>
  ...
  data() {
    return {
      customers: [
        ...
        { name: 'Makenna Kenter', telefone: '85 981382732', start_date: '22/03/2023', stage: 'teste@hotmail.com', progress: 100, status: 'Ativo' },
        { name: 'Makenna Kenter', telefone: '85 981382732', start_date: '22/03/2023', stage: 'teste@hotmail.com', progress: 25, status: 'Ativo' },
        { name: 'Hanna Culhane', telefone: '85 981382732', start_date: '12/03/2023', stage: 'teste@gmail.com', progress: 100, status: 'Inativo' },
        { name: 'Hanna Culhane', telefone: '85 981382732', start_date: '12/03/2023', stage: 'teste@gmail.com', progress: 42, status: 'Inativo' },
