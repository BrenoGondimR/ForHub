      ...
      <Stepper>
        ...
        <StepperPanel header="Informações">
          <template #content="{ nextCallback }">
            <h4 class="mb-3"><strong>Editar Informações</strong></h4>
            <b-row>
        ...
        <StepperPanel header="Valores">
          <template #content="{ prevCallback, nextCallback }">
            <h4 class="mb-3"><strong>Editar Valores</strong></h4>
            <b-row>
        ...
        <StepperPanel header="Pagamentos">
          <template #content="{ prevCallback }">
            <h4 class="mb-3"><strong>Editar Formas de Pagamento</strong></h4>
            <b-row>
  ...
  data() {
    return {
      ...
      fieldsInfo: [
        ...
        {key: 'description', label: 'Descrição da Sala/Empresa', type: 'TextArea', value: '', error: false, errorMessage: 'Descrição é obrigatória', col: '6'},
        {key: 'phone', label: 'Telefone/WhatsApp', type: 'InputText', value: '', error: false, errorMessage: 'Telefone/WhatsApp é obrigatório', col: '6'},
        {key: 'wifi', label: 'Wi-Fi', type: 'Checkbox', value: false, error: false, errorMessage: '', col: '2'},
        {key: 'quadro', label: 'Quadro Branco', type: 'Checkbox', value: false, error: false, errorMessage: '', col: '2'},
        {key: 'sala_reuniao', label: 'Sala de Reunião', type: 'Checkbox', value: false, error: false, errorMessage: '', col: '2'},
        {key: 'cafe', label: 'Café', type: 'Checkbox', value: false, error: false, errorMessage: '', col: '2'},
        {key: 'estacionamento', label: 'Estacionamento', type: 'Checkbox', value: false, error: false, errorMessage: '', col: '2'},
        {key: 'area_relaxamento', label: 'Área de Relaxamento', type: 'Checkbox', value: false, error: false, errorMessage: '', col: '2'},
